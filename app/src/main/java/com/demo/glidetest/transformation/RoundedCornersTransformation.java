...
public class RoundedCornersTransformation extends BitmapTransformation {
    ...
    public RoundedCornersTransformation(int radius, int margin) {
        this(radius, margin,RoundedCornersTransformation.CornerType.ALL);
    }

    public RoundedCornersTransformation(int radius, int margin, RoundedCornersTransformation.CornerType cornerType) {
        this.radius = radius;
